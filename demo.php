...
$con=mysql_connect('localhost','avinashresearch_avinashiih',"rsmlr270459");
   ...
   if (isset($_POST['update'])) {
   	...
   	$query="UPDATE class SET DYNASTY='$dynasty',DATE='$date',STONE='$stone',CPOM='$cpom',ARCHAEOLOGY='$archaeology',NUMISMATICS='$numismatics',PURANAITHIGASA='$puranaithigasa',OTHERTEXTS='$othertexts',FOREIGNAUTHORS='$foreignauthors' where SNO='$sno'";
   	$query_run=mysql_query($query,$con);
   	if ($query_run) {
